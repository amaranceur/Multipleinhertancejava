 ...
 * @author elon musk
 */
public class Electronicinter extends javax.swing.JFrame {

    /**
     * Creates new form Clothesinter
     */
    public Electronicinter() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestion De Produit(Produits)");
        ...
        jButton1.setText("Ajouter les Produits");
  ...
  ElectronicSt sc;
  try {
      sc = new ElectronicSt(name,price,AS,size);
      JOptionPane.showMessageDialog(null, "Le Produit a ete stockes ", "Confirmation", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Electronicinter().setVisible(true);
            }
        });
    }
